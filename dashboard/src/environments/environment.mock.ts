export const environment = {
    mock: true,
    incidentUrl: "http://localhost:4200/",
    resourceUrl: "http://localhost:4200/",
    categorizationUrl: "http://localhost:4200/",
    idpLoginUrl: "http://localhost:4200/login",
