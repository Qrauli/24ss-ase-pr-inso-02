package at.ase.respond.categorization;
...
import at.ase.respond.categorization.presentation.controller.SignatureController;
...
public class SignatureControllerTest {
    ...
    final private static String USER = "testUser";
    ...
    public void testVerifySignature_verified_shouldReturnTrue() {
        LogDTO logDTO = new LogDTO("Test", "INFO", "Test", USER, "test", "signature");
